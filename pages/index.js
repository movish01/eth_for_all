...
export default function Home() {
  ...
  async function loadNFTs() {
    const provider = new ethers.providers.JsonRpcProvider(
      "https://polygon-mumbai.g.alchemy.com/v2/F9n4vbebShnJO2KG_oFxjxsIZsePXZWD"
    );
      ...
      <div>
        <div className="hero max-h-full">
          <div className="hero-content grid grid-cols-2 mr-0">
            ...
            <div className="">
              <img
                src="https://cdn.dribbble.com/users/729829/screenshots/16260314/media/9dfadcc88b20dedf690e6c76d542cb73.png"
        ...
        <h1 className="px-20 py-10 text-4xl font-bold">
          {" "}
          No items to show in Marketplace{" "}
        </h1>
      </div>
    );
            ...
            {nfts.map((nft, i) => (
              ...
              >
                ...
                <div class="p-6">
                  ...
                  <p class="text-gray-700 text-base mb-4">{nft.description}</p>
                  <p className="break-words">
                    <span className="text-purple-500">Created By - </span>
                    <span className="text-sm">{nft.seller}</span>
                  </p>
